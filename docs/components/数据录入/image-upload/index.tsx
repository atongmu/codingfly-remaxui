 ...
 * @Author: codingfly
 * @Description:
 * @Date: 2021-08-26 13:40:10
 * @LastEditTime: 2021-09-08 15:51:58
 * @FilePath: \annar-master\docs\components\data-entry\image-upload\index.tsx
 */
import * as React from 'react';
import { Image, View } from 'remax/one';
import { ImageUpload, Box } from '@codingfly/remaxui';
      ...
      <Block noTitlePadding title="Children">
        <ImageUpload files={value7} onChange={handleChange7} maxCount={1}>
          <Image
            mode="widthFix"
            src={fontUrl}
            style={{ width: '221px', height: '144px' }}
          />
        </ImageUpload>
      </Block>
    </Frame>
