...
import { Stepper,  } from '@codingfly/remaxui';
...
export default () => {
  ...
  return (
    <Frame  padding className={styles.app}>
      <Block title="Basic">
      ...
      <Block title="Step">
        <View className={styles.container}>
          <Stepper
            step={3}
            value={number1}
            onChange={(val: any) => setNumber1(val)}
          />
        </View>
      </Block>
      <Block title="Min">
        <View className={styles.container}>
          <Stepper
            min={2}
            value={number2}
            onChange={(val: any) => setNumber2(val)}
          />
        </View>
      </Block>
      <Block title="Max">
        <View className={styles.container}>
          <Stepper
            max={3}
            value={number3}
            onChange={(val: any) => setNumber3(val)}
          />
        </View>
      </Block>
      <Block title="Disabled">
        <View className={styles.container}>
          <Stepper
            disabled
            value={number4}
            onChange={(val: any) => setNumber4(val)}
          />
        </View>
      </Block>
      <Block title="Plain">
        <View className={styles.container}>
          <Stepper
            plain
            value={number5}
            onChange={(val: any) => setNumber5(val)}
          />
        </View>
      </Block>
      <Block title="Size">
        <View className={styles.container}>
          <Stepper
            size="small"
            value={number12}
            onChange={(val: any) => setNumber12(val)}
          />
          <Stepper
            size="small"
            plain
            value={number13}
            onChange={(val: any) => setNumber13(val)}
          />
        </View>
      </Block>
      <Block title="Shape">
        <View className={styles.container}>
          <Stepper
            shape="circle"
            value={number6}
            onChange={(val: any) => setNumber6(val)}
          />
          <Stepper
            shape="circle"
            plain
            value={number7}
            onChange={(val: any) => setNumber7(val)}
          />
        </View>
      </Block>
      <Block title="Color">
