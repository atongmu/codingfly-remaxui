 ...
 * @Author: codingfly
 * @Description:
 * @Date: 2021-08-19 16:31:30
 * @LastEditTime: 2021-09-08 15:52:11
 * @FilePath: \annar-master\docs\components\data-entry\rate\index.tsx
 */
import * as React from 'react';
import { View } from 'remax/one';
import {  Rate } from '@codingfly/remaxui';
  ...
  return (
    <Frame grayBg padding>
      ...
      <Block noTitlePadding title="Size">
        <Rate value={value7} onChange={(v) => setValue7(v)} />
      </Block>
