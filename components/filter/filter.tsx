 ...
 * @Author: codingfly
 * @Description:
 * @Date: 2021-08-18 16:47:01
 * @LastEditTime: 2021-09-06 09:01:28
 * @FilePath: \young\components\filter\filter.tsx
 */
...
const InternalFilter = (props: FilterProps) => {
  ...
  const filterItems = React.Children.map(
    children,
  ...
  return (
    <View className={prefixCls} style={filterStyle}>
      <View
        ...
        style={{ height: showMask ? '100%' : '100px' }}
      >
