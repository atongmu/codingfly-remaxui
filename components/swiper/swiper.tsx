...
import { throttle, guid } from './../_utils';
  ...
  const throttleTouchMove = useCallback(
    throttle(
      (e: any) => {
        ...
        const diff =
          (vertical ? touch.pageY : touch.pageX) - startPoint.current;
    ...
    >
      <View
        className={classNames(`${prefixCls}-track`, {
          [`${prefixCls}-track-vertical`]: vertical,
        })}
        ...
        style={{
          transform: `translate3d(${
            vertical ? '0, ' + distance + 'PX' : distance + 'PX, 0'
          }, 0)`,
          transition,
        }}
      >
