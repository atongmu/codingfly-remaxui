 ...
 * @LastEditTime: 2021-09-06 09:01:44
 * @FilePath: \young\components\form\form.tsx
 */
...
const AnnarForm: React.FC<FormProps> = (props: FormProps) => {
  const { initialValues, form, children, onFinish, onFinishFailed, onReset } =
    props;
  ...
  const { initStore, setErrors, setCallbacks } =
